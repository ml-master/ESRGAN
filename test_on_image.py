...
parser.add_argument("--image_path", type=str, required=True, default="./images/310.png",help="Path to image")
parser.add_argument("--checkpoint_model", type=str, required=True, default="./saved_models/generator_25.pth" ,help="Path to checkpoint model")
